...
def build_system_menu_kb(
    ...
    if is_admin:
        keyboard = [
            ...
            [KeyboardButton(text=i18n.t(lang, "SYS_OFFER"))],
        ]
    else:
        keyboard = [
            [
...
def build_admin_channel_panel_kb(lang: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [InlineKeyboardButton(text=i18n.t(lang, "CHANNEL_TEST_RESET_BALANCE"), callback_data="admin:channel:test_reset_balance")],
