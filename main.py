...
def _format_history_pro_block(lang: str, history_summary: dict[str, Any]) -> str:
    ...
    if lang == "ru":
        return "\n".join(
            [
                ...
                "ℹ️ Пояснение",
                "━━━━━━━━━━━━━━━━",
                "• Score ≥ 80 — используются для расчёта winrate и RR",
                "• Score < 80 — сигналы для анализа структуры рынка и волатильности",
            ]
        )
    ...
    return "\n".join(
        [
            ...
            "• Score < 80 — used for market structure and volatility analysis",
        ]
    )
