...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "ALT_CHOP_TOGGLE_LABEL": "ALT CHOP: {mode}",
        "ALT_CHOP_TOGGLE_ALERT": "ALT CHOP режим: {mode}",
        "SYS_DIAG": "🧪 Диагностика",
        "admin_diag_running": "⏳ Выполняю диагностику...",
        "admin_diag_busy": "⏳ Уже выполняется...",
        "admin_diag_debounce": "⏳ Подождите...",
        ...
        "DIAG_ALT_CHOP_MODE_LINE": "ALT chop filter: enabled={enabled}, mode={mode}, apply_to={apply_to}, source={source}",
        "DIAG_ALT_CHOP_STATE_LINE": "alt_chop={alt_chop}, ft_median={ft_median} (<= {threshold}), valid_count={valid}/{min_required}, samples={samples}",
        "DIAG_ALT_CHOP_SKIPS_LINE": "skipped_by_alt_chop_total={total}, reasons(top): {reasons}",
        "DIAG_ALT_CHOP_SOFT_LINE": "alt_chop_soft_strict_total={count}, strict_n={strict_n}",
    ...
    "en": {
        ...
        "ALT_CHOP_TOGGLE_LABEL": "ALT CHOP: {mode}",
        "ALT_CHOP_TOGGLE_ALERT": "ALT CHOP mode: {mode}",
        "SYS_DIAG": "🧪 Diagnostics",
        "admin_diag_running": "⏳ Running diagnostics...",
        "admin_diag_busy": "⏳ Already running...",
        "admin_diag_debounce": "⏳ Please wait...",
