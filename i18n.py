...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "STATS_PRO_TP_TOTAL": "🟢 TP: {tp_total}",
        "STATS_PRO_SL_TOTAL": "🔴 SL: {sl_total}",
    ...
    "en": {
        ...
        "STATS_PRO_BELOW_THRESHOLD_SCORE": "Score < 80",
        "STATS_PRO_BELOW_THRESHOLD_LINE1": "• Not included in stats",
        "STATS_PRO_BELOW_THRESHOLD_LINE2": "• Market analysis only",
        "STATS_PRO_SUMMARY_HEADER": "📈 Period totals",
