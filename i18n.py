...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "HISTORY_PAGE_INFO": "Стр. {page}/{pages} | Всего: {total}",
        "HISTORY_PRO_RECOMMENDED_HEADER": "🔥 Рекомендуемые сигналы",
        "HISTORY_PRO_SCORE_RANGE_90_100": "Score 90–100",
        "HISTORY_PRO_WINRATE_LINE": "• Winrate: {winrate}",
        "HISTORY_PRO_AVG_RR_LINE": "• Средний RR: {avg_rr}",
        "HISTORY_PRO_TOTAL_SIGNALS_LINE": "• Всего сигналов: {count}",
        "HISTORY_PRO_STATUS_PRIMARY": "• Статус: 🟢 Основной фокус",
        "HISTORY_PRO_RR_NOTE": "ℹ️ При RR > 2 даже 40–45% дают положительное ожидание.",
        "HISTORY_PRO_DIVIDER": "————————————",
        "HISTORY_PRO_HIGH_RISK_HEADER": "⚠️ Повышенный риск",
        "HISTORY_PRO_SCORE_RANGE_80_89": "Score 80–89",
        "HISTORY_PRO_STATUS_SELECTIVE": "• Статус: 🟡 Использовать выборочно",
        "HISTORY_PRO_DIVIDER_SHORT": "───────────",
        "HISTORY_PRO_BELOW_THRESHOLD_HEADER": "🚫 Score < 80",
        "HISTORY_PRO_BELOW_THRESHOLD_LINE1": "• В статистике не учитывается",
        "HISTORY_PRO_BELOW_THRESHOLD_LINE2": "• Используется только для анализа рынка",
        "HISTORY_PRO_TOTALS_HEADER": "📈 Итоги по сделкам",
        "HISTORY_PRO_TP_TOTAL": "🟢 TP: {tp_total}",
        "HISTORY_PRO_SL_TOTAL": "🔴 SL: {sl_total}",
        "HISTORY_PRO_NEUTRAL_TOTAL": "⏳ Neutral: {neutral_total}",
        "HISTORY_PRO_IN_PROGRESS_TOTAL": "🕒 В процессе: {in_progress_total}",
    ...
    "en": {
        ...
        "HISTORY_PAGE_INFO": "Page {page}/{pages} | Total: {total}",
        "HISTORY_PRO_RECOMMENDED_HEADER": "🔥 RECOMMENDED SIGNALS",
        "HISTORY_PRO_SCORE_RANGE_90_100": "Score 90–100",
        "HISTORY_PRO_WINRATE_LINE": "• Winrate: {winrate}",
        "HISTORY_PRO_AVG_RR_LINE": "• Avg RR: {avg_rr}",
        "HISTORY_PRO_TOTAL_SIGNALS_LINE": "• Total signals: {count}",
        "HISTORY_PRO_STATUS_PRIMARY": "• Status: 🟢 Main focus",
        "HISTORY_PRO_RR_NOTE": "ℹ️ With RR > 2, even 40–45% winrate can be positive expectancy.",
        "HISTORY_PRO_DIVIDER": "————————————",
        "HISTORY_PRO_HIGH_RISK_HEADER": "⚠️ HIGHER RISK",
        "HISTORY_PRO_SCORE_RANGE_80_89": "Score 80–89",
        "HISTORY_PRO_STATUS_SELECTIVE": "• Status: 🟡 Use selectively",
        "HISTORY_PRO_DIVIDER_SHORT": "───────────",
        "HISTORY_PRO_BELOW_THRESHOLD_HEADER": "🚫 Score < 80",
        "HISTORY_PRO_BELOW_THRESHOLD_LINE1": "• Not included in stats",
        "HISTORY_PRO_BELOW_THRESHOLD_LINE2": "• Market analysis only",
        "HISTORY_PRO_TOTALS_HEADER": "📈 Period totals",
        "HISTORY_PRO_TP_TOTAL": "🟢 TP: {tp_total}",
        "HISTORY_PRO_SL_TOTAL": "🔴 SL: {sl_total}",
        "HISTORY_PRO_NEUTRAL_TOTAL": "⏳ Neutral: {neutral_total}",
        "HISTORY_PRO_IN_PROGRESS_TOTAL": "🕒 In progress: {in_progress_total}",
        ...
        "SIGNAL_RESULT_HEADER_SL": "❌ SL — Stop Loss hit",
