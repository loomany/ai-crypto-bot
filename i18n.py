...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "HISTORY_PRO_SCORE_90_100": "Score 90–100",
        ...
        "HISTORY_PRO_SCORE_80_89": "Score 80–89",
        "HISTORY_PRO_STATUS_SELECTIVE": "• Статус: 🟡 Использовать выборочно",
        "HISTORY_PRO_BELOW_80_HEADER": "🚫 Score < 80",
        ...
        "HISTORY_PRO_TP_TOTAL": "🟢 TP: {count}",
        "HISTORY_PRO_SL_TOTAL": "🔴 SL: {count}",
        "HISTORY_PRO_NEUTRAL_TOTAL": "⏳ Neutral: {count}",
        "HISTORY_PRO_IN_PROGRESS_TOTAL": "🕒 В процессе: {count}",
    ...
    "en": {
        ...
        "HISTORY_PRO_SCORE_90_100": "Score 90–100",
        "HISTORY_PRO_WINRATE_LINE": "• Winrate: {winrate}",
        "HISTORY_PRO_AVG_RR_LINE": "• Average RR: {avg_rr}",
        "HISTORY_PRO_TOTAL_SIGNALS_LINE": "• Total signals: {count}",
        "HISTORY_PRO_STATUS_PRIMARY": "• Status: 🟢 Primary focus",
        "HISTORY_PRO_DIVIDER": "----------------------------------",
        "HISTORY_PRO_HIGH_RISK_HEADER": "⚠️ Elevated risk",
        "HISTORY_PRO_SCORE_80_89": "Score 80–89",
        "HISTORY_PRO_STATUS_SELECTIVE": "• Status: 🟡 Use selectively",
        "HISTORY_PRO_BELOW_80_HEADER": "🚫 Score < 80",
        "HISTORY_PRO_BELOW_80_LINE1": "• Not included in statistics",
        "HISTORY_PRO_BELOW_80_LINE2": "• Used only for market analysis",
        "HISTORY_PRO_TOTALS_HEADER": "📈 Trade totals",
        "HISTORY_PRO_TP_TOTAL": "🟢 TP: {count}",
        "HISTORY_PRO_SL_TOTAL": "🔴 SL: {count}",
        "HISTORY_PRO_NEUTRAL_TOTAL": "⏳ Neutral: {count}",
        "HISTORY_PRO_IN_PROGRESS_TOTAL": "🕒 In progress: {count}",
