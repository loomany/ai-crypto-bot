...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "SIGNAL_ACTIVATED_GUEST_DELAY_LINE": "⏱ Уведомление для гостевого доступа отправлено с задержкой 30 минут.",
        "SIGNAL_ACTIVATED_GUEST_SUBSCRIPTION_LINE": "🔒 Полные сигналы без задержки доступны только при активной подписке.",
    ...
    "en": {
        ...
        "SIGNAL_ACTIVATED_GUEST_DELAY_LINE": "⏱ Guest-access notification was sent with a 30-minute delay.",
        "SIGNAL_ACTIVATED_GUEST_SUBSCRIPTION_LINE": "🔒 Full no-delay signals are available only with an active subscription.",
