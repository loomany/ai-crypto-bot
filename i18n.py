...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "DIAG_LAST_CLOSE_EVENT_HEADER": "• Последний close event:",
        "DIAG_LAST_CLOSE_EVENT_LINE": "  • ts={ts} module={module} symbol={symbol} side={side} result={result} score={score} entry={entry} sl={sl} tp1={tp1} tp2={tp2} user_id={user_id} event_id={event_id} signal_id={signal_id}",
        "DIAG_LAST_CLOSE_EVENT_NONE": "• Последний close event: нет",
        "DIAG_PENDING_CLOSE_HEADER": "• Pending close notifications: {count}",
        "DIAG_PENDING_CLOSE_LINE": "  • id={id} ts={ts} symbol={symbol} result={result} user_id={user_id} attempts={attempts} claimed_by={claimed_by} claim_ts={claim_ts}",
        "DIAG_PENDING_CLOSE_NONE": "  • нет pending",
        "DIAG_CLOSE_DETECTOR_HEADER": "• Close detector snapshot:",
        "DIAG_CLOSE_DETECTOR_CHECKED": "  • close_detector_checked_signals={count}",
        "DIAG_CLOSE_DETECTOR_SKIPPED": "  • close_detector_skipped_signals_total={count}",
        "DIAG_CLOSE_DETECTOR_SKIP_REASONS": "  • skip_reasons(top): {reasons}",
        "DIAG_CLOSE_DETECTOR_TRIGGERED": "  • close_detector_triggered_total={count}",
        "DIAG_CLOSE_DETECTOR_SNAPSHOT": "  • last_close_check_snapshot: last_checked_ts={last_checked_ts} last_price_ts={last_price_ts}",
    ...
    "en": {
        ...
        "DIAG_LAST_CLOSE_EVENT_HEADER": "• Last close event:",
        "DIAG_LAST_CLOSE_EVENT_LINE": "  • ts={ts} module={module} symbol={symbol} side={side} result={result} score={score} entry={entry} sl={sl} tp1={tp1} tp2={tp2} user_id={user_id} event_id={event_id} signal_id={signal_id}",
        "DIAG_LAST_CLOSE_EVENT_NONE": "• Last close event: none",
        "DIAG_PENDING_CLOSE_HEADER": "• Pending close notifications: {count}",
        "DIAG_PENDING_CLOSE_LINE": "  • id={id} ts={ts} symbol={symbol} result={result} user_id={user_id} attempts={attempts} claimed_by={claimed_by} claim_ts={claim_ts}",
        "DIAG_PENDING_CLOSE_NONE": "  • no pending",
        "DIAG_CLOSE_DETECTOR_HEADER": "• Close detector snapshot:",
        "DIAG_CLOSE_DETECTOR_CHECKED": "  • close_detector_checked_signals={count}",
        "DIAG_CLOSE_DETECTOR_SKIPPED": "  • close_detector_skipped_signals_total={count}",
        "DIAG_CLOSE_DETECTOR_SKIP_REASONS": "  • skip_reasons(top): {reasons}",
