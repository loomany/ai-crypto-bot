...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "explanation_line_be": "🟢 BE (+8%) — цена дала минимум +8% прибыли, прибыль защищена.",
        ...
        "SIGNAL_BE_TRIGGERED_HEADER": "🟢 BE активирован (+{level}%) — прибыль защищена",
        "SIGNAL_BE_FINALISED_HEADER": "🟢 BE (+{level}%) — прибыль защищена",
        "SIGNAL_BE_LEVEL_LINE": "🛡 BE уровень: {price}",
        "SIGNAL_BE_REACHED_LINE": "🛡 Дошло до BE: {price}",
        ...
        "SIGNAL_CURRENT_PRICE_LINE": "Текущая цена: {price}",
        "SIGNAL_BE_LEVEL_PERCENT_LINE": "🛡 BE уровень: +{level}%",
        ...
        "SIGNAL_RESULT_MAX_PNL_LINE": "📈 Max PnL: +{pnl}%",
    ...
    "en": {
        ...
        "SIGNAL_BE_TRIGGERED_HEADER": "🟢 BE activated (+{level}%) — profit protected",
        "SIGNAL_BE_FINALISED_HEADER": "🟢 BE (+{level}%) — profit protected",
        "SIGNAL_BE_LEVEL_LINE": "🛡 BE level: {price}",
        "SIGNAL_BE_REACHED_LINE": "🛡 Reached BE: {price}",
        "SIGNAL_BE_MAX_PNL_LINE": "🛡 Max PnL: {pnl}%",
        ...
        "SIGNAL_CURRENT_PRICE_LINE": "Current price: {price}",
        "SIGNAL_BE_LEVEL_PERCENT_LINE": "🛡 BE level: +{level}%",
        "SIGNAL_RESULT_PNL_LINE": "PnL: {pnl}%",
        "SIGNAL_RESULT_SL_LINE": "🛑 SL: {price}",
        "SIGNAL_RESULT_TP1_LINE": "🎯 TP1: {price}",
        "SIGNAL_RESULT_TP2_LINE": "🎯 TP2: {price}",
