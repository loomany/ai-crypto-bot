...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "HISTORY_EMPTY_PERIOD": "За выбранный период история пуста.",
        "HISTORY_NO_SIGNALS_BUTTON": "Нет сигналов за период ({period}).",
        "HISTORY_LOAD_ERROR": "Не удалось загрузить историю. Попробуй ещё раз позже.",
    ...
    "en": {
        ...
        "HISTORY_LOAD_ERROR": "Unable to load history. Please try again later.",
