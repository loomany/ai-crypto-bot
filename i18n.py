...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "HISTORY_PRO_RECOMMENDED_TITLE": "🔥 Рекомендуемые сигналы",
        "HISTORY_PRO_BUCKET_90": "Score 90–100",
        "HISTORY_PRO_WINRATE": "• Winrate: {value}",
        "HISTORY_PRO_AVG_RR": "• Средний RR: {value}",
        "HISTORY_PRO_TOTAL_SIGNALS": "• Всего сигналов: {value}",
        "HISTORY_PRO_STATUS_PRIMARY": "• Статус: 🟢 Основной фокус",
        "HISTORY_PRO_RR_NOTE": "ℹ️ При RR > 2 даже 40–45% дают положительное ожидание.",
        "HISTORY_PRO_DIVIDER": "————————————",
        "HISTORY_PRO_HIGH_RISK_TITLE": "⚠️ Повышенный риск",
        "HISTORY_PRO_BUCKET_80": "Score 80–89",
        "HISTORY_PRO_STATUS_SELECTIVE": "• Статус: 🟡 Использовать выборочно",
        "HISTORY_PRO_DIVIDER_SHORT": "───────────",
        "HISTORY_PRO_BELOW_80_TITLE": "🚫 Score < 80",
        "HISTORY_PRO_BELOW_80_LINE1": "• В статистике не учитывается",
        "HISTORY_PRO_BELOW_80_LINE2": "• Используется только для анализа рынка",
        "HISTORY_PRO_TOTALS_TITLE": "📈 Итоги по сделкам",
        "HISTORY_PRO_TOTALS_TP": "🟢 TP: {value}",
        "HISTORY_PRO_TOTALS_SL": "🔴 SL: {value}",
        "HISTORY_PRO_TOTALS_NEUTRAL": "⏳ Neutral: {value}",
        "HISTORY_PRO_TOTALS_IN_PROGRESS": "🕒 В процессе: {value}",
    ...
    "en": {
        ...
        "HISTORY_PRO_RECOMMENDED_TITLE": "🔥 Recommended signals",
        "HISTORY_PRO_BUCKET_90": "Score 90–100",
        "HISTORY_PRO_WINRATE": "• Winrate: {value}",
        "HISTORY_PRO_AVG_RR": "• Avg RR: {value}",
        "HISTORY_PRO_TOTAL_SIGNALS": "• Total signals: {value}",
        "HISTORY_PRO_STATUS_PRIMARY": "• Status: 🟢 Primary focus",
        "HISTORY_PRO_RR_NOTE": "ℹ️ With RR > 2, even 40–45% can still have positive expectancy.",
        "HISTORY_PRO_DIVIDER": "————————————",
        "HISTORY_PRO_HIGH_RISK_TITLE": "⚠️ Higher risk",
        "HISTORY_PRO_BUCKET_80": "Score 80–89",
        "HISTORY_PRO_STATUS_SELECTIVE": "• Status: 🟡 Use selectively",
        "HISTORY_PRO_DIVIDER_SHORT": "───────────",
        "HISTORY_PRO_BELOW_80_TITLE": "🚫 Score < 80",
        "HISTORY_PRO_BELOW_80_LINE1": "• Excluded from statistics",
        "HISTORY_PRO_BELOW_80_LINE2": "• Used for market analysis only",
        "HISTORY_PRO_TOTALS_TITLE": "📈 Trade totals",
        "HISTORY_PRO_TOTALS_TP": "🟢 TP: {value}",
        "HISTORY_PRO_TOTALS_SL": "🔴 SL: {value}",
        "HISTORY_PRO_TOTALS_NEUTRAL": "⏳ Neutral: {value}",
        "HISTORY_PRO_TOTALS_IN_PROGRESS": "🕒 In progress: {value}",
