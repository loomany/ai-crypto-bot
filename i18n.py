...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "SIGNAL_BE_TRIGGERED_HEADER": "🟢 BE (+8%) активирован — прибыль защищена",
        "SIGNAL_BE_FINALISED_HEADER": "🟢 BE (+8%) — прибыль защищена",
        "SIGNAL_BE_LEVEL_LINE": "🛡 BE уровень: {price}  (+8%)",
        "SIGNAL_BE_REACHED_LINE": "🛡 Дошло до BE: {price}  (+8%)",
    ...
    "en": {
        ...
        "SIGNAL_BE_TRIGGERED_HEADER": "🟢 BE (+8%) activated — profit protected",
        "SIGNAL_BE_FINALISED_HEADER": "🟢 BE (+8%) — profit protected",
        "SIGNAL_BE_LEVEL_LINE": "🛡 BE level: {price}  (+8%)",
        "SIGNAL_BE_REACHED_LINE": "🛡 Reached BE: {price}  (+8%)",
        "SIGNAL_BE_MAX_PNL_LINE": "🛡 Max PnL: {pnl}%",
