...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "DIAG_BTC_TREND_1H": "• BTC тренд 1H: {trend}",
        "DIAG_BTC_TREND_4H": "• BTC тренд 4H: {trend}",
        "DIAG_BTC_EMA_BIAS": "• EMA bias: {bias}",
        "DIAG_BTC_ATR_VOL": "• ATR волатильность: {value}",
    ...
    "en": {
        ...
        "DIAG_BTC_TREND_1H": "• BTC trend 1H: {trend}",
        "DIAG_BTC_TREND_4H": "• BTC trend 4H: {trend}",
        "DIAG_BTC_EMA_BIAS": "• EMA bias: {bias}",
        "DIAG_BTC_ATR_VOL": "• ATR volatility: {value}",
