...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "USER_PAGE_HEADER": "Стр. {page}/{total_pages} | Всего: {total}",
        "USER_PAGE_BACK": "⬅️ Назад",
        "USER_PAGE_FORWARD": "➡️ Вперёд",
    ...
    "en": {
        ...
        "USER_PAGE_HEADER": "Page {page}/{total_pages} | Total: {total}",
        "USER_PAGE_BACK": "⬅️ Back",
        "USER_PAGE_FORWARD": "➡️ Forward",
