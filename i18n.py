...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "btn_binance_status": "🤖 Binance: статус",
        "btn_refresh": "🔄 Обновить",
        "binance_status_title": "🤖 Статус Binance",
        "binance_status_testnet": "🧪 Режим: TESTNET",
        "binance_status_mainnet_disabled": "⚠️ MAINNET отключён",
        "binance_trading_on": "✅ Автоторговля: ВКЛ",
        "binance_trading_off": "⛔ Автоторговля: ВЫКЛ",
        "binance_balance": "💰 Баланс USDT:",
        "binance_positions": "📌 Позиции:",
        "binance_orders": "📄 Ордера:",
        "binance_none": "нет",
        "binance_error": "❌ Ошибка Binance:",
        "binance_details_admin_only": "ℹ️ Подробности доступны только админу",
    ...
    "en": {
        ...
        "btn_binance": "📈 Binance",
        "btn_binance_spot": "📈 Binance",
        "btn_binance_status": "🤖 Binance: status",
        "btn_refresh": "🔄 Refresh",
        "binance_status_title": "🤖 Binance Status",
        "binance_status_testnet": "🧪 Mode: TESTNET",
        "binance_status_mainnet_disabled": "⚠️ MAINNET disabled",
        "binance_trading_on": "✅ AutoTrading: ON",
        "binance_trading_off": "⛔ AutoTrading: OFF",
        "binance_balance": "💰 USDT Balance:",
        "binance_positions": "📌 Positions:",
        "binance_orders": "📄 Orders:",
        "binance_none": "none",
        "binance_error": "❌ Binance error:",
        "binance_details_admin_only": "ℹ️ Details are available for admin only",
        "SIGNAL_SHORT_SIDE_LONG": "📈 LONG",
        "SIGNAL_SHORT_SIDE_SHORT": "📉 SHORT",
        "SIGNAL_SHORT_SYMBOL_SIDE_LINE": "{symbol} · {side}",
        "SIGNAL_SHORT_POI_LINE": "POI: {poi_from}–{poi_to}",
