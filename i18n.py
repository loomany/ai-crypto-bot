...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "history_title": "📜 История сигналов — {period}",
        "page_total": "Стр. {page}/{pages} | Всего: {total}",
        ...
        "totals_tp": "🟢 TP: {value}",
        "totals_be": "🟢 BE: {value}",
        "totals_be_avg": "🟢 BE: {value} (avg +{avg}%)",
        "totals_sl": "🔴 SL: {value}",
        ...
        "line_winrate_tp_be": "📊 Winrate (TP+BE): {value}% | Trades: {trades}",
        ...
        "explanation_line_be": "🟢 BE — цена дала прибыль, прибыль защищена.",
    ...
    "en": {
        ...
        "history_title": "📜 Signal history — {period}",
        "page_total": "Page {page}/{pages} | Total: {total}",
        ...
        "explanation_line_be": "🟢 BE — price moved into profit, profit protected.",
